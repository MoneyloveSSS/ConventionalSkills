...
| 売ります     | うります         |      | 卖（売る）                         |
| 話します     | はなします       |      | 说话（話す）                       |
| 渡します     | わたします       |      | 过（桥、河），穿过（马路）（渡す） |
| 下ろします   | おろします       |      | 取、卸货（下ろす）                 |
| 選びます     | えらびます       |      | 挑选（選ぶ）                       |
| 消します     | けします         |      | 关（灯），消除，去除（消す）       |
| 歩きます     | あるきます       |      | 步行（歩く）                       |
| 曲がります   | まがります       |      | 拐弯（曲がる）                     |
| 洗います     | あらいます       |      | 洗（洗う）                         |
| 出ます       | でます           |      | 离开（出る）                       |
...
| 食事します   | しょくじします   |      | 吃饭（食事する）                   |
| 整理します   | せいりします     |      | 整理（整理する）                   |
| コピーします |                  |      | 复印（copy）（コピーする）         |
| 暗い         | くらい           | ０   | 黑暗                               |
| 大変         | たいへん         | ０   | 够受的，不得了                     |
| なかなか     |                  | ０   | 相当，很                           |
| こう         |                  | ０   | 这样                               |
...
| 顔               | かお                 | ０   | 脸                       |
| 頭               | あたま               | ３   | 头，头脑                 |
| IDカード         | アイディーカード     | ５   | 身份证件                 |
| 間違い           | まちがい             | 3    | 错误，失误               |
| 問題             | もんだい             | 0    | 问题                     |
| 広告             | こうこく             | 0    | 广告                     |
| 看板             | かんばん             | 0    | 牌子                     |
| 展示場           | てんじじょう         | 0    | 展示会场                 |
| 入場料           | にゅうじょうりょう   | 3    | 门票，入场费             |
| サービス         |                      | 1    | 服务 (service)           |
| 天井             | てんじょう           | 0    | 天棚                     |
| 警備             | けいび               | 1    | 戒备，警备               |
| クリスマスツリー |                      | 7    | 圣诞树（Christmas tree） |
| 皆さん           | みなさん             | 2    | 大家，谐位               |
| 子               | こ                   | 0    | 孩子                     |
| 横               | よこ                 | 0    | 旁边，侧面               |
| 持ちます         | もちます             | 3    | 有，拥有，持有（持つ）   |
| 住みます         | すみます             | 3    | 居住（住む）             |
| 知ります         | しります             | 3    | 认识，知道，了解（知る） |
| 直します         | なおします           | 4    | 改，修改，改正（直す）   |
| 片づけます       | かたづけます         | 5    | 收拾，鉴理（片付ける）   |
| 練習します       | れんしゅうします     | 6    | 练习(練習する)           |
| 結婚します       | けっこんします       | 6    | 结婚(結婚する)           |
| 安心します       | あんしんします       | 6    | 安心，放心（安心する）   |
| 明るい           | あかるい             | 0    | 明亮，开朗               |
| 長い             | ながい               | 2    | 长，久远                 |
| 無い             | みじかい             | 3    | 短，短質                 |
| 軽い             | かるい               | 0    | 轻巧，轻，轻松，轻微     |
...
形容词描写句中，形容詞作谓语。形容词本身结句，就有断定的含义。所以<u>「です」只表达尊敬，为副词</u>。
...
否定也可写为：形容词連用形＋ある（連用形）＋ます（未然形）＋ん＝形容词連用形＋ありません。
...
> - 私は　コーヒーをは　飲みません。　　（对比，即其他可以喝，但不喝咖啡）
...
形容動詞描写句中，形容動詞作谓语。<u>「です」同时表达尊敬、断定，为动词</u>。
...
***どの名詞　/　いつ　/　どれ　/　だれ　/　何が　いちばん　形/形動　です　か***
...
时间范围时：週、一週間、１か月、１年、毎日。如「先週」、「毎日」等无需加助词「に」。

> 例：
>
> - 李さんは　一週間に　２回　ぐらい　プールへ　行きます。
> - この花は　２年に　1度　咲きます。
...
- ぐらい/くらい：大概
  ...
  > 例：ここがら　駅まで　１キロメートルくらいです。

- **どのくらい　かかりますか：询问多久、多少钱**

  > 例：
  >
  > - 家から　会社まで　どのくらい　かかりますか。
  >
  >   電車で　１時間ぐらい　かかりますか。
  >
  > 精确询问时间/金钱时：
...
- 表示经过某个场所，常见的动词：通ります、渡ります、過ぎます
- 表示离开某个个场所，常见的动词：出ます、卒業します
...
- 駅前：表示车辆附近。如需要表示车站前面，使用「駅の前」

- なかなか：表示程度的副词，用于实际情况高于预期，有表示意外的语气

  > 例：小野さんの　料理は　なかなか　美味しです。　（原本以为不好吃）

- 動てくださいませんか：「動てください」的更礼貌用法

- そうしてください：表示请这样做。「そうして」为「そうする」的て形
...
表示两句见的转折关系时，用助词“が”，意思为“但是，可是”。

> 例：
>
> - 3か月　パソコンを　勉強しましたが、まだ　あまりですません。
...
- ![image-20231113181007996](asserts/janpanese/image-20231113181007996.png)

- 日文中，费用的词语很多

  <img src="asserts/janpanese/image-20231113181143200.png" alt="image-20231113181143200" style="zoom: 33%;" />
...
[详解日语动词的15种形态](https://zhuanlan.zhihu.com/p/369733906?utm_id=0)

- **未然形**

  - **否定形**：用于表示否定意义的动词形式，未然形后加"~ない"

    > 例：行く→行かない，食べる →食べない

  - **可能・自発形**：用于表达可能性的动词形式，或自发态表示某种自发的心情，或表达被动，某物被～。

    未然形后加“~れる"/"られる"

    > **五段动词的可能形发生了约音变，即未然形词尾「あ」段音与「れ」约音为对应的「え」段音。**サ变动词为「できる」，其余无变化。
    >
    > 例：可能：書く→書ける，食べる→食べれる，くる→こられる，する→できる
    >
    > 自発/ 被动：飲む→飲まれる，食べる→食べれる，くる→こられる，する→される

  - **使役形**：用于表示“使某人做某事”的动词形式。未然形上加上“~せる”/“~させる”

    > 例：行く→行かせる
    
  - **推量形**：用于表示推量和意志。未然形上加上“う”/“よう”
...
- **連用形**
  ...
  - **て形**：通常用于**构成复合时态、表示动作进行的状态或目的**等

    > 例：書く→書いて

  - **ます形**：通常称为“敬体”或“礼貌体”，用于表示正式或客气的口语和书面语
...
- **命令形**：用来表示命令、请求或建议等意思，分为肯定命令和否定命令两种形式
...
**終止形・連体形**：**动词的連体形、终止形和辞书形（原形）的一样的。**
...
- 未然形
  ...
  > - **う段　→　同行的あ段**（非推量）（「う」只能变为「わ」不能变成其对应段的「あ」）
  > - **う段　→　同行的お段**（推量）
...
- 未然形
  ...
  > - カ变动词：こ
  >
  > - サ变动词：有三种，分别为「し」、「せ」、「さ」。根据后面接的助动词不同，需要用不同的形式。
  >
  >   しない、せぬ、される
...
- **「動て動」：动词て形后接动词，表示两个动作相继发生**

  > 例：
  >
  > - 昨日　デパートへ　行って、買い物しました。
  > - 家へ　帰って、宿題を　します。
  > - 図書館へ　行って　本を　借りて、家へ　帰ります。　（可多个て连用）
  
- **「動てから　動」：同样表示两个动作相继发生**，但「てから」只能在同一句子中出现一次
...
- **動ています （结果状态）：除了表示现在进行的意义外，还能表示动作结束后留下的结果状态**
...
**です 的含义包含「断定」和「尊敬」两部分；只表示尊敬时，为副词；同时表示断定、尊敬时，为动词。**
...
- **「です」作助词，属于附属词，无实际意义，无词形和时态的变化，只起到礼貌作用**
  - 形容词描写句
    ...
    > 形容词本身结句，就有断定的含义。所以，要表达尊敬，添加一个只表达「尊敬」的成分。
...
- 否定形：では/じゃ ありません
  ...
  > 「である」的否定形式即「でありません」，加上表示强调的「は」就变成了「ではありません」。
- 过去形：でした
- 过去否定形：では/じゃ ありませんでした
...
形容词主要可以分为**"形容詞”（い形容詞、1形容詞)和"形容動詞”（な形容詞、2形容詞)**两类。
...
- **連用形**
  ...
  - **連用形（く）：**<u>后连接形容词，用于多个形容词修饰；也可作副词修饰动词</u>；用于停顿，表示两个以上的分句并列。多用于书面语中
  ...
  - **て形：**<u>后连接形容词，用于多个形容词修饰</u>；用于停顿，表示两个以上的分句并列。形式：**連用形（く）＋て**

    > 例：寒て、速くて安い

  - **否定形**：形式：連用形（く）＋ない

    > 形容词否定形为：形容詞連用形＋ない。其中「ない」为形容词，而不是助动词，所以前接連用形。
    >
    > 否定形是以「ない」结尾的，所以整体看作一个新的形容词处理。
...
- **未然形**
  ...
  - **推量形**
    ...
    > 较为古老的口语中，使用形容词的未然形+推量。如「寒かろう」。
    >
    > 目前较多使用是：形容词原型+「です」未然形+推量。如：「今日は寒いでしょう」；或形容词原型+「だろう」，如「良いだろう」。
...
- **連用形**
  ...
  - **連用形（で）**：<u>后连接形容词，用于多个形容词修饰</u>；用于停顿，表示两个以上的分句并列
  ...
  - **否定形**：形式：連用形（で）＋はない　/　じゃない

    > 形容動詞否定形为：形容動詞連用形＋は＋ない。其中「ない」为形容词，而不是助动词，「は」表强调，所以前接連用形。
    >
    > 否定形是以「ない」结尾的，所以整体看作一个新的形容词处理。
...
- 表示进行某个动作、作用或具有某种性质、 状态的主体，构成句子的主语
  ...
  > **「が」通常用来强调句子中的主语，将其置于焦点位置。而「は」则用于强调句子中的主题，即对话中的话题。因此，「が」通常用于介绍新事物，而「は」则用于回答有关某个主题的问题。**
  >
  > 例：子供が泣いている。　雨が降る。
...
<img src="asserts/janpanese/image-20230710113848379.png" alt="image-20230710113848379" style="zoom: 25%;" />

- 「自立語」与「付属语」，共同构成「文節」
- 多个「文節」构成「文」（句子）
- 多个「文」组成「段落」，多个「段落」组成「文章」





**「文節」可作为「主語」、「述語」、「修飾語」、「接続語」、「独立語」**

**「文」的核心是「主語」、「述語」（谓语）。**

<img src="asserts/janpanese/image-20230710134007114.png" alt="image-20230710134007114" style="zoom: 33%;" />
...
- **能作为主语使用的词语（主語になる）　→　体言**
  ...
  > - 名詞
  >
  > - 代名詞：用来代替人或事物的名称，例：わたし、あなた、彼、彼女
  > - 数詞：表示数目和数量的单位，例：一、一つ
  > - 副詞：修饰用言，例：たくさん、すごい
  > - 連体詞：修饰体言，例：この、あの、その
  > - 接続詞：起接续作用，例：でも、しかし
  > - 感嘆詞：表示感叹，呼唤或应答，例：はい、ええ、いいえ
...
<img src="asserts/janpanese/image-20230710142246322.png" alt="image-20230710142246322" style="zoom:33%;" />



**形容詞**

<img src="asserts/janpanese/image-20230710142649921.png" alt="image-20230710142649921" style="zoom:33%;" />



**形容動詞**

<img src="asserts/janpanese/image-20230710142730899.png" alt="image-20230710142730899" style="zoom:33%;" />



**助動詞**

用在用言后，起一定的语法作用。**助動詞不但有活用，还对它们接续的用言，有形式的要求。**

助動詞做动词时，才需要活用。作助词时，无活用。

![image-20230710142914118](asserts/janpanese/image-20230710142914118.png)

![image-20230710143040058](asserts/janpanese/image-20230710143040058.png)![image-20230710143057483](asserts/janpanese/image-20230710143057483.png)

![image-20230710143223487](asserts/janpanese/image-20230710143223487.png)

![image-20230710143238401](asserts/janpanese/image-20230710143238401.png)
...
> 如：書く（变連用形）＋ます　→　書きます　→　書きまし（連用形）＋た　→　書きました。
>
> 書か＋せ＋られ＋ませ＋ん＋でし＋た　→　書かせられませんでした。
...
- **格助詞**：表示词与词，特别是词与谓语之间的关系
- **接続助詞**：表示句子内部，小句与小句之间的关系
...
<img src="asserts/janpanese/image-20230710151237302.png" alt="image-20230710151237302" style="zoom:33%;" />
...
- **単文：谓语只存在一处**
  ...
  > 例：冷たい雨が激しく<u>降りそそいだ</u>。

- **複文：谓语存在两处及以上，且句子区分主句、从句**

  > 例：先生が<u>言った</u>言葉が胸に<u>響いた</u>。

- **重文：谓语存在两处及以上，句子不区分主句、从句**

  > 例：兄は<u>高校生で</u>、妹は<u>小学生だ</u>。
