...
https://zhuanlan.zhihu.com/p/369733906?utm_id=0

- **未然形**

  - **否定形**：用于表示否定意义的动词形式，大多数动词通过在基本形后加"~ない"构成

    > 例：“食べる” →”食べない”。

  - **可能・自発形**：用于表达可能性的动词形式，或表达被动，某物被～。通常在基本形上加上“~れる"/"られる"构成

    > 例：“走る”→“走れる”，“飲む”→“飲まれる”。

  - **使役形**：用于表示“使某人做某事”的动词形式。通常在动词基本形上加上“~せる”/“~させる”
